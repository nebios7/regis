...
$sheet->setCellValue('D1', 'อาจารย์ที่ปรึกษา');

$sheet->setCellValue('E1', 'สิทธิ์ฝึกงาน');
$sheet->setCellValue('F1', 'สิทธิ์ทำโครงงาน');
$sheet->setCellValue('G1', 'หน่วยกิต');
$sheet->setCellValue('H1', 'ผลการเรียน');
$sheet->setCellValue('I1', 'รายละเอียด');
