...
(function($) {
    $.fn.timeSchedule = function(options){
        ...
        this.init = function(){
            ...
            var cell_num = Math.floor((tableEndTime - tableStartTime) / setting.widthTime);
            var before_time = -1;
            var countAfterTime = 0;
            var afterTime = ["09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00"];
            for(var t=tableStartTime;t<tableEndTime;t+=setting.widthTime){
                ...
                if(
                    ...
                    var html = '';
                    html += '<div class="sc_time">'+ element.formatTime(t) +' - '+afterTime[countAfterTime]+'</div>';
                    countAfterTime++;
