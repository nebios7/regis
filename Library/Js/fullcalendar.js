...
FC.durationHasTime = durationHasTime;
   // var dayIDs = [ 'อาทิตย์', 'จันทร์', 'อังคาร', 'พุธ', 'พฤหัส', 'ศุกร์', 'เสาร์' ];
var dayIDs = [ 'sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat' ];
var intervalUnits = [ 'year', 'month', 'week', 'day', 'hour', 'minute', 'second', 'millisecond' ];


  //  var intervalUnits = [ 'ปี', 'เดือน', 'อาทิตย์', 'วัน', 'ชั่วโมง', 'นาที', 'วินาที', 'มิลลิวินาที' ];
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
    ...
    nameRoom: null, // the text that will be displayed in the header's nameRoom
    section: null, // the text that will be displayed in the header's section
    totalOfPeople: null, // the text that will be displayed in the header's totalOfPeople
    IDsubject: null, // the text that will be displayed in the header's IDsubject
    nameSubjectThai: null, // the text that will be displayed in the header's nameSubjectThai
    nameSubjectEng: null, // the text that will be displayed in the header's nameSubjectEng
    credit1: null, // the text that will be displayed in the header's credit1
    credit2: null, // the text that will be displayed in the header's credit2
    credit3: null, // the text that will be displayed in the header's credit3
    credit4: null, // the text that will be displayed in the header's credit4
    ID_SectionOfDetailsOpenCourse: null, // the text that will be displayed in the header's ID_SectionOfDetailsOpenCourse
	status: null, // the text that will be displayed in the header's status
    ID_Teacher: null, // the text that will be displayed in the header's ID_Teacher
    objective: null, // the text that will be displayed in the header's objective
    ID_DetailOfExamSubject: null, // the text that will be displayed in the header's ID_DetailOfExamSubject
    totalOfNisit: null, // the text that will be displayed in the header's totalOfNisit
    Section: null, // the text that will be displayed in the header's Section
    totalOfExamTime	: null, // the text that will be displayed in the header's totalOfExamTime
