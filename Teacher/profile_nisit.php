...
table {
    ...
    line-height: 0.8cm;
    width: 100%;
    /*border: 1px solid #ddd; border-spacing: 0;width: 100%;*/
}

th {
    width: 20%;
    font-size : 20px;
    background: rgba(71, 169, 115, 0.69);
    border-radius: 10px;
    padding-left: 10px;
}
td
{
    width: 40%;
    font-size : 20px;
    background: rgba(71, 169, 115, 0.42);
    border-radius: 10px;
    padding-left: 10px;
...
h3
{
    border-bottom:2px solid #224F4B;
    font-weight: bold;
    font-size: 25px;
}
...
<div class="picside">
        <div>
            <img class="img-circle" id="avatar-edit-img"  src="../Image/profile.png"  data-holder-rendered="true" src="default.jpg"/>
            <center><a type="button" class="btn btn-primary" id="change-pic">ผลการเรียน</a></center>
        </div>
