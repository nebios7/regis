<?php
$dataPoints = array(
    array('y' => 3.43, 'label' => '2559 ต้น'),
    array('y' => 3.16, 'label' => '2559 ปลาย'),
    array('y' => 2.86, 'label' => '2560 ต้น'),
    array('y' => 3.13, 'label' => '2560 ปลาย'),
    array('y' => 2.98, 'label' => '2561 ต้น'),
    array('y' => 3.63, 'label' => '2561 ปลาย'),
...
<h2>รายชื่อนิสิตในคณะวิศวกรรมศาสตร์ กำแพงแสน</h2>
    <a href="../ex_teacher.php" class="btn btn-success"><span class="glyphicon glyphicon-file"></span> <font size="3px">Excel</font></a>
    <a href="../print_teacher.php" class="btn btn-danger"><span class="glyphicon glyphicon-file"></span> <font size="3px">PDF</font></a>
    ...
    <br>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <a href="#profile"data-toggle="modal" class="profile"><i class="material-icons icon-blue" title="profile">&#xe87c;</i></a>
                    <a href="#chart" data-toggle="modal" class="grade"><i class="material-icons icon-orange" title="chart">&#xe01d;</i></a>
                </td>
            </tr>
            <tr>
